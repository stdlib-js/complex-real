...
```javascript
real = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-real@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/complex-real@v0.1.1-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/complex-real/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/complex-real/actions/workflows/test.yml?query=branch:v0.1.1
